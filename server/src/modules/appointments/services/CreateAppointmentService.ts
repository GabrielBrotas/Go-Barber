...
class CreateAppointmentService {
  ...
  constructor(
    ...
    // o private vai automaticamente criar a variavel appointmentsRepository ao inves de definir ela no topo e usar o this.appointmentsRepository = appointmentsRepository;
  ) {}
